...
class ThisGuy extends React.Component {
  ...
  say (phrase) {
    ...
    Velocity(dialogText, {scaleX: 0.3, scaleY: 0.3, opacity: 0.3},
      {duration: 0})
    ...
    Velocity(dialogText, {opacity: 1.0},
      {duration: 200, easing: 'easeOutCirc', queue: false})

    Velocity(dialogText, { translateY: '-400px' }, {
      duration: 6000,
      queue: false,
    ...
    setTimeout(() => {
      ...
      Velocity(dialogText, { opacity: 0.0 },
